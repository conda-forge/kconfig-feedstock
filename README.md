...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kconfig-feedstock/blob/master/LICENSE.txt)
...
<table>
  ...
  <tr>
    ...
    <td>
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8472&branchName=master">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kconfig-feedstock?branchName=master">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8472&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kconfig-feedstock?branchName=master&jobName=linux&configuration=linux_64_c_compiler_version7cxx_compiler_version7" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `kconfig` can be installed with:

```
conda install kconfig
```

It is possible to list all of the versions of `kconfig` available on your platform with:
